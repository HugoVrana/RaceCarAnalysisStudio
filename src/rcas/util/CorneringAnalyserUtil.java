...
public class CorneringAnalyserUtil {
     ...
     *
     * @param raceCar  - race car object
     * @param carSpeed - speed of the car in m/s.
     * @param beta     - vehicle slip angle "beta" in degrees (�).
     * @param delta    - steering angle "delta" in degrees (�).
     */
     ...
     * considered.
     *
     * @param raceCar - the race car object
     ...
     *
     * @param raceCar   - the race car object
     * @param beta      - body slip angle in degrees
     * @param deltaFrom - steering angle from in degrees
     * @param deltaTo   - steering angle to in degrees
     ...
     *
     * @param raceCar  - the race car object
     * @param delta    - steering angle in degrees
     * @param betaFrom - body slip angle from in degrees
     * @param betaTo   - body slip angle to in degrees
     * @return A formatted string with the results
     */
    ...
    private class MMMSinglePoint {
        ...
        /**
         * @param beta - the body slip angle beta in degrees (�) to be set.
         */
        ...
        /**
         * @param lateralAccel - the lateralAccel to set in m/s^2.
         */
        ...
        /**
         * @param yawMoment - the yaw moment around the CoG in Nm.
         */
