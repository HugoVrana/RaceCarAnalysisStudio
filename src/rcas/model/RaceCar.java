...
public class RaceCar {
     ...
     *
     * @param cornerWeightFL - Front Left corner weight in kg.
     * @param cornerWeightFR - Front Rear corner weight in kg.
     * @param cornerWeightRL - Rear Left corner weight in kg.
     * @param cornerWeightRR - Rear Right corner weight in kg.
     */
    ...
    /**
     * @param name the name of the car to be set
     */
    ...
    /**
     * @param frontTrack the frontTrack to set in m.
     */
    ...
    /**
     * @param rearTrack the rearTrack to set in m.
     */
    ...
    /**
     * @param wheelbase the wheelbase to set in m.
     */
    ...
    /**
     * @param cogHeight the cogHeight to set in m.
     */
    ...
    /**
     * @param frontRollDist - front roll distribution coefficient (0-1).
     */
    ...
    /**
     * @param cornerWeightFL the cornerWeightFL to set in kg.
     */
    ...
    /**
     * @param cornerWeightFR the cornerWeightFR to set in kg.
     */
    ...
    /**
     * @param cornerWeightRL the cornerWeightRL to set in kg.
     */
    ...
    /**
     * @param cornerWeightRR the cornerWeightRR to set in kg.
     */
    ...
    /**
     * @param frontAxleTireModel the frontAxleTireModel to set
     */
    ...
    /**
     * @param rearAxleTireModel the rearAxleTireModel to set
     */
